...
//                                 memberName, // Use company-specific name
//                                 project.name,
...
//         console.log(`\n📊 Cron Jobs Summary:`);
//         console.log(`   Projects processed: ${upcomingProjects.length}`);
//         console.log(`   Projects with reminders enabled: ${projectsWithReminders}`);
//         console.log(`   Total emails sent: ${totalEmailsSent}`);
//         console.log(`   Execution time: ${executionTime}ms`);
//         console.log(`Cron Jobs completed!\n`);

//     } catch (error) {
//         console.error('Error in sendProjectReminders:', error);
//     }
// }
